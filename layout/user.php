<!DOCTYPE html>
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      <div class="sidebar-heading">Loja Nelson Mandela <span class="badge badge-secondary">Nº406</span></div>
      <div class="list-group list-group-flush">
        ...
        <a href="biblioteca.php" class="list-group-item list-group-item-action bg-light">
