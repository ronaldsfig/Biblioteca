<!DOCTYPE html>
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      <div class="sidebar-heading">Loja Nelson Mandela <span class="badge badge-secondary">Nº206</div>
      <div class="list-group list-group-flush">
        <a href="index.php" class="list-group-item list-group-item-action bg-light">Usuários</a>
        <a href="publicacoes.php" class="list-group-item list-group-item-action bg-light">Publicações</a>
      </div>
    </div>
    <!-- /#sidebar-wrapper -->
